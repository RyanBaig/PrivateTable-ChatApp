...
package.domain = com.ryanbaig.privatetable
...
# (list) List of Java files to add to the android project (can be java or a .dex file)
#android.add_src =
...
# (list) Additional gradle repositories to add {can be necessary for some android packages}
